...
export const Header = () => {
  ...
  return (
    <body className="max-w-[1440px] mx-auto">
      <nav className=" px-4 py-5 flex justify-between text-white">
        <div className="flex justify-between items-center">
          <a className="text-3xl font-bold leading-none" href="#">
            Logo
          </a>

          <div className="hidden transform  translate-x-1/2  lg:mx-auto gap-5 lg:flex  lg:items-center  lg:w-auto lg:space-x-6">
            <a className="poppins text-lg font-bold " href="#">
              Home
            </a>
            ...
            <button className="bg-gray-500 rounded-md w-32 h-14">
              CONNECT
            </button>
          </div>
        </div>
